...
// Kiểm tra nếu số lượng sản phẩm hợp lệ và nếu hết hàng
$isOutOfStock = isset($sanPham['so_luong']) && $sanPham['so_luong'] <= 0;
?>
            ...
            <div class="col-md-7 d-flex flex-column">
                ...
                <?php else: ?>
                    <form action="<?= BASE_URL_CLIENT . '?act=post-them-gio-hang' ?>" method="POST" class="mt-3 d-flex align-items-center">
                        ...
                        <input type="number" name="so_luong" min="1" max="<?= max(1, $sanPham['so_luong']) ?>" value="1" class="form-control w-25 mr-3">
