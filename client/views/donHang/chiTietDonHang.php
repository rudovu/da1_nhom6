             ...
             <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b>Tổng tiền:</b> <?= isset($detailDonHang['tong_tien']) ? number_format($detailDonHang['tong_tien']) . ' VNĐ' : '0 VNĐ' ?><br>
                  <b>Ghi chú:</b> <?= $detailDonHang['ghi_chu'] ?><br>
                  <b>Phương thức thanh toán:</b> <?= $detailDonHang['ten_phuong_thuc'] ?><br>
                </div>
              </div>
              <?php if (is_array($detailSanPham)) : ?>
                      ...
                      <div class="col-md-7">
                        <div class="card-body">
                          ...
                          <p class="text-danger font-weight-bold h5">
                            Giá: <?= isset($detailSanPham['gia_khuyen_mai']) ? number_format($detailSanPham['gia_khuyen_mai']) . ' VNĐ' : 'Chưa cập nhật' ?>
                          </p>
                        </div>
                        <div class="col-md-12">
              ...
              <?php else : ?>
                <div class="alert alert-warning mt-3">Không tìm thấy thông tin sản phẩm.</div>
              <?php endif; ?></div>
          <?php endif; ?>
        </div>
      </div>
